...
describe('Service Tests', () => {
    describe('Credential Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CredentialService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/credentials';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Credential', () => {
                service.create(new Credential(null)).subscribe(received => {
            ...
            it('should update a Credential', () => {
                service.update(new Credential(123)).subscribe(received => {
