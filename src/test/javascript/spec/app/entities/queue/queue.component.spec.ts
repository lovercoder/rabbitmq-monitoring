    ...
    describe('Queue Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(QueueComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.queues[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
